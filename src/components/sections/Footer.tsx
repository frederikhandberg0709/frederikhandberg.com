...
export default function Footer() {
  return (
    <div className="relative flex flex-col items-center justify-center gap-10 text-white">
      ...
      <div className="absolute bottom-0 -z-10 hidden h-full w-full sm:block min-[2000px]:hidden">
        <div className="footer-gradient">
          <Image
            ...
            height="0"
            sizes="100vw"
            className="absolute bottom-0 z-[-19] h-full w-full bg-no-repeat object-cover"
            alt="Decoration"
          />
        </div>
      </div>
